...
class ActiveTripScreen extends ConsumerWidget {
  ...
  const ActiveTripScreen({super.key, required this.trip, required this.status});
          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Calling office dispatcher... (Mock)'),
                ),
              );
            },
          ),
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Dialing passenger... (Mock)'),
                          ),
                        );
                      },
                    ),
                    ...
                    child: OutlinedButton.icon(
                      ...
                      onPressed: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Launching navigation map routing... (Mock)',
                            ),
                          ),
                        );
                      },
